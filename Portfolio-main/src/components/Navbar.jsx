...
const Navbar = () => {
  ...
  const email = 'subhashnukabathini123@gmail.com'

  return (
    <div className="z-50 fixed w-full h-[80px] flex justify-between items-center px-4 bg-transparent backdrop-blur-sm text-gray-300">
      <div>
        ...
        <ul>
          <li className="w-[60px] h-[60px] flex justify-between items-center hover:bg-gradient-to-r from-blue-500 ">
            <a
              ...
              href="https://www.linkedin.com/in/subhash-nukabathini-1945b622a/"
              target="_blank"
          ...
          <li className="w-[60px] h-[60px] flex justify-between items-center hover:bg-gradient-to-r from-gray-500 ">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/letsbegin1234"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaGithub size={30} />
